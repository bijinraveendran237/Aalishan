...
const Navbar = () => {
    ...
    return (
        <nav
            ...
            <h1 className="headtext__cormorant font-bold mb-4">Aalishan Celebrations</h1>
            
            </div>
            <ul className='navbar-end lg:flex hidden justify-end items-center flex-1 duration-300 gap-2'>
                <li
